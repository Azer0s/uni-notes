...
* **Hypothese:** Finder*innen werfen einen "zufällig gefundenen" Brief *<u>seltener</u>* in den Briefkasten wenn sie *<u>negative</u>* Einstellungen gegenüber dem Empfänger haben

**Ziel**

aus dem Verhältniss der *verlorenen* zu den von den Finder*innen *abgeschickten* Briefen wird auf die Einstellung der Bevölkerung eines Gebiets zu den jeweiligen Empfänger*innen geschlossen

* Erfassen der Einstellung gegenüber politischen Gruppierungen oder Institutionen

**Vorteile**

* höhere Authentizitätder Erhebengssituation
* natürliche, nicht aufdringliche Umgebung

**Nachteile**

* Kontrolle der unabhängigen Variable (z.B. Stimmung der Versuchsperson)
* unkontrollierbare Störvariablen (z.B. Wetter)

**=> Ist Nicht-Abschicken tatsächlich ein Hinweis auf die Einstellung?**
